...
export CFLAGS_FOR_TARGET="-O2 -isysroot $SDKROOT -mmacosx-version-min=11.0 $ARCH_FLAG"
export CXXFLAGS_FOR_TARGET="-O2 -isysroot $SDKROOT -mmacosx-version-min=11.0 $ARCH_FLAG -std=c++11"
